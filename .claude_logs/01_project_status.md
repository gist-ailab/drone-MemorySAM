...
| **Det 객체검출 (Jarvis)** | 🏁 **P30-Det(det_P30_v2) 학습완료**(40ep, 2026-07-02) | 최종 mAP **0.1291** / **mAP50 0.2562** / mAP75 0.1163(best_checkpoint=ep39). NaN은 AMP-off로 근절·완주. **목표 mAP50 0.85 미달**, 검출 best-overall=**P29-Det ep9 mAP50 0.446**(P30은 small-obj collapse 한계). 후속 레버: query↑/deformable/FCOS-aux 소물체 담당. P30-Det 완료 후 **bundle을 ep34→50 연장 재학습 중**(det_P29_v2_bundle resume, tmux p29hold, ep39 mAP50 0.3565). 모니터 RUN-7(완료)/RUN-8(bundle연장) |
