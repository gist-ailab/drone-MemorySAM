...
## 7. P29-Det vs P30-Det 비교 (2026-07-02, hinton eval)

동일 파이프라인(`objdet/tools/diag_det.py`, letterbox, v2 test 1772장)으로 hinton GPU0/1에서 평가. 원본 = `.claude_logs/det_eval/` (COMPARE md + csv + diag_summary.json), canonical = `/mnt/HDD2/src/logs/P29_vs_P30_v2_20260702/`.

- **P29-Det** `det_P29_v2_bundle` best **ep9(최종)**: AP 0.269 / **AP50 0.446** / AP75 0.283 · AP small0.120 med0.168 large0.348
- **P30-Det** `det_P30_v2` best **ep24(학습중 스냅샷)**: AP 0.108 / **AP50 0.228** / AP75 0.088 · AP small0.006 med0.026 large0.174

클래스별 AP50 (Δ=P30−P29): Obstacles 0.40/0.40(+0.00) · Allies 0.50/0.48(−0.02) · Enemies 0.42/0.33(−0.08) · Casualties 0.56/0.47(−0.09) · Doors 0.34/0.16(−0.18) · Windows 0.41/0.22(−0.20) · FireExt 0.39/0.02(−0.37) · LandingMarkers 0.53/0.15(−0.37) · EmergencyExits 0.45/0.03(−0.42) · Lighting 0.46/0.02(−0.44).

**결론**: P30는 균일 열세가 아니라 **대형 객체(사람·장애물)는 P29와 대등, 소형·얇은 객체(소화기·마커·비상구·조명)에서 붕괴** → 전체 −0.217 AP50 격차의 대부분이 소형 객체. 원인 = object-query decoder(DETR류)의 소형객체 약점(query 수·저해상도 샘플링) + ep24 미수렴. **현 최선 = P29-Det ep9(AP50 0.446).** P30 개선 레버: query 수↑ / 고해상도(deformable) 샘플링 / FCOS-aux가 소형 담당. hinton eval 환경 재사용: `hinton:~/src/dm_eval`(code@087aac8, ROOT=/ailab_mat2).
