...
|---|---|---|---|---|
| DELIVER · test | DGFusion 56.71 / 2차 MM SAM-adapter 57.35 | **56.39**(legal v2) / 55.18(legal v1(구)) / 56.99(1024 격자(제외)) — 단일 런(시드 고정 기능이 없던 시점의 무작위 시드) · 학습기 val-best(top1) · 유효(legal v2 채택 2026-09-18; E1 시드2·3·E13 시드1~3 v2 재채점 5건·val 재채점 대기) | −0.32(legal v2 56.39, DGFusion 56.71) — SOTA 미달 · −0.96(MM SAM-adapter 57.35) | [카드 §5-34 (2-정정)](../decisions/2026-09-07-daily-cycle-experiment-cards.md) · [ISSUE-036](../issues/issues-and-fixes.md) · [judgment-ledger 2026-09-18 행](../experiments/judgment-ledger.md) |
| 〃 · val | CAFuser-CAA 68.79 / 2차 MM SAM-adapter 69.6 | **69.39**(legal v2) / 67.37(v1 같은 ckpt) / 67.89(v1 최고 시드3) — 단일 시드(시드1 val-best epoch140_68.9_top1) — 시드2·3 v2 val 대기, 3시드 전 확정 금지 · 학습기 val-best(top1) · 잠정(단일 시드; 시드2·3 v2 val 후 확정) | +0.60(CAFuser-CAA 68.79) — 단일 시드라 주장 보류 · −0.21(MM SAM-adapter 69.60) | [judgment-ledger 2026-09-18 v2 val 행](../experiments/judgment-ledger.md) · [카드 §5-29(v1 시드3)](../decisions/2026-09-07-daily-cycle-experiment-cards.md) |
