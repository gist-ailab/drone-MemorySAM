...
- **데드 outputs**: P10~P17 68G → `/mnt/HDD2/src/archive/MemorySAM_dead_outputs_20260708/` 이동 완료(검증 후 원본 삭제). **잔여 ~105G 보류 — ISSUE-023**(/mnt/HDD2 ntfs-3g 전면 쓰기불능 ENOSPC, 사용자 조치 필요). `outputs/ARCHIVE_MANIFEST.md` 참조.
