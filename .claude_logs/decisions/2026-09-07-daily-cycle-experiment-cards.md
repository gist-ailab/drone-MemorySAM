...
### 5-16. ⚠️ 스크린의 클래스별 이득 프로필은 200ep 에서 보존되지 않는다 — E13 확정 1페어 예비 (2026-09-12)

**판정이 아니다.** E13 확정 런의 완주 전 val-best(`epoch100_67.84`, 현재 ep145 진행 중)를 GPU 공백에
재채점한 **1페어 예비** 수치이며, 완주 시 val-best 가 갱신되면 버린다(§0-1).

| 지표 | E13 확정(ep100) | 분모(seed821 200ep) | Δ |
|---|---|---|---|
| 25클래스 | 55.67 | 53.57 | **+2.09** |
| RailTrack | 68.45 | 26.96 | **+41.49** |
| **24클래스** | 55.13 | 54.68 | **+0.45** |
| 얇은 객체 4 | 45.19 | 43.25 | +1.93 |

출처: jarvis `logs/E13confirm_test_20260911_224404.log`(1897/1897 장, BS1 확인).
