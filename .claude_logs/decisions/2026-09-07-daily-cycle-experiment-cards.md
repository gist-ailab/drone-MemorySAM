...
| **E3b 센서 간 일치항 (완주, 재채점 중)** | 트레이너 val ep5~40 = 59.66/55.88/62.00/63.17/63.59/62.26/**63.69**/63.60 (val-best ep35). E3(AGREE 0.0) 같은 지점 = 59.35/63.72/62.23/65.44/**65.97**/65.51/65.61/65.69. Δ(E3b−E3) = +0.31/−7.84/−0.23/−2.27/−2.38/−3.25/−1.92/−2.09 | 🟡 **8지점 중 7지점 음수, val-best끼리 −2.28** → 센서 간 prototype 일치 항(`AGREE_LAMBDA` 0.1)이 해롭다는 방향. 판정은 legal test로(재채점 진행 중, jarvis GPU5). E3의 이득이 RailTrack 한 클래스(+38.39)에 몰려 있었으므로 **E3b 가 RailTrack 을 얼마나 잃었는지**가 일치 항의 작용을 가장 직접 보여준다 | jarvis `logs/e3b_agree_launch.log`, 총 6:58:57, ckpt `epoch35_63.69_top1`(로그의 `Best Test 53.46@ep20` 은 test-best 라 무효) |
