...
| **E1 4탭 읽기 (완주, 재채점 중)** | 트레이너 val ep5~40 = 60.98/63.56/66.30/66.57/66.43/66.88/**67.25**/66.74 vs B0 58.71/63.17/62.18/63.91/64.03/65.13/…/65.4. val-best **ep35 67.25**(내부 최고 67.74와 0.49 차) | 🔵 val +1.85(트레이너, 같은 시점). legal 재채점(ep35 ckpt, bengio GPU0, test+val) 진행 중 — 판정은 그 test 하나로만 | bengio `logs/e1_taps_screen40_20260907_223704.log`, `logs/e1_eval_{test,val}_ep35_*.log` |
