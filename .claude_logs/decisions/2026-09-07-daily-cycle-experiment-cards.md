...
| **E4b** | 혼동 쌍 margin(명시 5쌍) | 66.07@ep35 | 65.00 | 55.14 | +1.36 | +0.03 | 증폭 | 🔴 **판정 재검토 필요** — 24클래스 Δ는 +0.58이 아니라 **+0.08**(§5-8 분모 정정)로 부기준 +0.5 미달. 25클래스 +1.36만 통과선을 넘는다(35ep 기준; ep36~40 Adam ComplexFloat로 미완주) |
