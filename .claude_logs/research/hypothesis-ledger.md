...
| H22 | frozen 백본 위 어댑터-만 정렬 사전학습(P50-MAP)이 타깃 성능 이득 | P50 finetune vs 무사전학습 seed821 매칭 통제 | ✓ **확인(2026-08-31)** | legal test **54.95 = +0.74**(재선택 기준)/+1.38(구 기준) ≥ 게이트 +0.5 — 캠페인 "정보 축" 첫 양성. 이득은 조기 수렴 국면 집중(val-best ep30, 이후 하락) → 조기정지와 결합. P52 편입 + 스케일업 확장 후보 | 동상 |
