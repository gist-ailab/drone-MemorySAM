...
| [17_p29det_data_fix.md](17_p29det_data_fix.md) | **객체탐지(P29-Det/P30-Det)** — poongsan 미레이블-배경 데이터 수정·v2/v3 split·**P29 vs P30 비교(AP50 0.446 vs 0.228)**. per-class 원본 `.claude_logs/det_eval/` |
