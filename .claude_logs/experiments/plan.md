...
| **E13M 시드3** | hpca100 3 | MUSES 3모달 | 40 | ep36 — 최고 80.61@35 | 09-16 20시경 | E13M 셋째 페어(§5-28) |
...
> 🟡 **09-16 MCubeS 같은 코드 쌍 2개**: 시드 3407 +0.38 · 시드 0828 **−0.26** → 2페어 평균 +0.06 으로 게이트(+0.5) 미달, 부호도 갈림. 셋째 페어(0827)는 09-16 21시경(§5-30 ②).
