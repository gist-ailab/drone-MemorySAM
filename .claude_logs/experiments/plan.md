...
| **6** | **CEA oracle 프로브** (조건-전문가 상한) | 빈 GPU 1~2장 × 조건 3런 | 현행 1024² 판정 후 | [decisions/2026-08-08-condexpert-adapter-probe-proposal.md](../decisions/2026-08-08-condexpert-adapter-probe-proposal.md) — 조건×클래스 어댑터(CEA) 방향의 oracle 조건-전문가 상한 프로브, 게이트 G-P1/G-P2 사전 등록 |
| **7** | **RGB-D 2모달 fair-eval** | 학습 0, 기존 ckpt @1024 재평가 | GPU 여유 시 | 기존 RGB-D 2모달 ckpt를 현행 @1024 프로토콜로 재평가해 공정 비교선 확보 |
