...
|---|---|---|---|---|---|---|
| **카드 E1** 중간층 4탭 읽기 | bengio 6,7 | DELIVER 4모달 | 40 | ep33/40 — ep5~30: 60.98/63.56/66.30/66.57/66.43/66.88 (B0 58.71/63.17/62.18/63.91/64.03/65.13/64.67/**65.40@40**) | 09-08 20:24 KST(33분/ep 실측) → `val.py` legal 재채점(GPU0 조기 재채점은 타 사용자 점유로 취소) | 카드 첫 통과 후보. 통과선 test ≥ 54.78(B0 53.78 + 1.0) |
| **카드 E3** 센서별 클래스 prototype | bengio 4,5 | DELIVER 4모달 | 40 | ep25/40 — ep5~25: 59.35/63.72/62.23/65.44/65.97 | 09-08 23:45 KST | user 가설 직접 검증 |
| **카드 E4** 혼동 쌍 margin(auto k5) | bengio 1,2,3 | DELIVER 4모달 | 40 | ep21/40 — ep5~20: 59.77/63.17/65.92/65.70 | 09-08 22:30 KST | auto 쌍에 RailTrack 누락 → 명시 쌍판 **E4b** config 추가(RailTrack→Sky/Static/Terrain, Wall→Building, Water→Terrain), 미기동 |
| **카드 E2** 전 선형층 LoRA r32·α64 | hpca100 1,3 | DELIVER 4모달 | 40 | ✅ **완주(09-08 17:24 KST, 18:26:55)** — 트레이너 val ep5~40: 62.54/63.44/60.09/62.40/65.25/66.91/67.85/**68.65**(val-best ckpt `epoch40_68.65_top1`). 🔴 로그의 `Best Test 55.57 (epoch 30)`은 test-best라 무효 | legal 재채점 진행 중(`configs/eval/hpca100-deliver_rgbdel_P46_E2_eval1024_legal.yaml`, test 84분+val) → 09-08 20시 KST | 구조 사다리 S2(= E-BB A1). 통과선 test ≥ 54.78 |
| **카드 E1M** MUSES 4탭 이식(E7 PhysAug-off 매칭 페어) | hpca100 3 | MUSES 3모달 | 40 | ep1/40 (09-08 17:37 KST 기동, 1.61 it/s, TAPS [6,12,18,24] per_modal) | 09-09 13시 KST 전후 | 공통 상승 검증: 공식 val Δ(E1M − E7) ≥ +1.0 |
| **카드 E7c** MUSES PhysAug-on 대조군 | hpca100 2 | MUSES 3모달 | 40 | ep24/40 — ep5 73.18 · ep10 75.52 · ep15 75.97 · ep20 77.68 | 09-08 20:26 KST → E7(완주, 트레이너 val 80.29@40)과 `tools/eval_muses_official.py` 페어 재채점 | PhysAug 효과 격리 → MUSES 헤드라인 교체 여부 |
