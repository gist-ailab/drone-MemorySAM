...
|---|---|---|---|---|---|---|
| **카드 E1** 중간층 4탭 읽기 | bengio 6,7 | DELIVER 4모달 | 40 | ep33/40 — ep5~30: 60.98/63.56/66.30/66.57/66.43/66.88 (B0 58.71/63.17/62.18/63.91/64.03/65.13/64.67/**65.40@40**) | 09-08 20:31 KST → `val.py` legal 재채점(bengio GPU0 비어 있음) | 카드 첫 통과 후보. 통과선 test ≥ 54.78(B0 53.78 + 1.0) |
