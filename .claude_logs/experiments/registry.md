...
| **ANALYSIS: P29·P31·P32·P34 표준분석 (lecun)** | seg-analysis | DELIVER test 5-cond | P29 ep146 + P31 ep182 + P32 ep158 + **P34 ep40(스냅샷)** | `tools/seg_analysis_pipeline.py` (D1,D2,D2N,D3,D3B,D4,D5) | lecun GPU0/1 | ckpt `/SSDb/jemo_maeng/ckpt/{P31,P32}/` | ✅ 완료 (2026-07-12) | 산출: NAS `/drone_nas/drone/analysis_logs/` (HDD2 ISSUE-023 재발로 대체). 종합=[analysis/2026-07-12-p29-p34-standard-analysis.md](analysis/2026-07-12-p29-p34-standard-analysis.md). P34 mean 53.96 전도메인 1위 | [tools/README_seg_analysis.md](../../tools/README_seg_analysis.md) (항목1-4 매핑) |
