...
| **ANALYSIS: P31+P32 풀 파이프라인 (lecun)** | seg-analysis | DELIVER test 5-cond | P31 test-best(54.85@ep182) + P32 test-best(55.01@ep158) | `tools/seg_analysis_pipeline.py` (D1,D2,D2N,D3,D3B,D4,D5) | lecun GPU0/1 | ckpt `/SSDb/jemo_maeng/ckpt/{P31,P32}/` | 🟡 실행 중 (2026-07-12 15:2x~) | 산출: lecun `/SSDb/jemo_maeng/analysis/{P31,P32}_eval_20260712/` + 실행로그 `~/analysis_logs/*.log` → 완료 후 `/mnt/HDD2/src/logs/`로 회수 | [tools/README_seg_analysis.md](../../tools/README_seg_analysis.md) (항목1-4 매핑) |
