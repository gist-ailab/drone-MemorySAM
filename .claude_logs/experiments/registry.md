...
| hpca100_deliver_rgbdel_P38_m2f | seg | DELIVER (img/depth/event/lidar) | P38 (MaskQueryLite) | `configs/hpca100-deliver_rgbdel_P38_m2f.yaml` | hpca100 (GPU 0-3, A100×4) | `outputs/MMSamP38/hpca100_deliver_rgbdel_P38_m2f/` (예상) | 🟡 active (2026-07-18 launch, 학습 중) | ep0 launch, ETA 07-19 완주 예상. P36 공정 레시피 동결 + Mask2Former-lite query head 1-변수 비교. 판정 게이트 = P36 fair(val 67.74/test 55.62) 대비 + thin-class(Wall/Water/RailTrack) IoU | [experiments/plan.md](plan.md), [../models/arch-evolution.md](../models/arch-evolution.md) P38 |
