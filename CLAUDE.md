...
새로운 대화나 작업 지시를 받으면, 코드 수정을 시작하기 전에 **반드시** `.claude_logs` 폴더 내의 다음 파일들을 읽고 현재 상황을 파악해라:
- `01_project_status.md`: 전체 진행 상황, 현재 최선 모델, 남은 과제
- `02_model_arch.md`: P8~P12 모델 아키텍처 상세, 변천 과정, 각 버전의 한계점
