...
\noindent\textbf{(2) Hybrid modulation for memory and fusion.}
We employ sigmoid-based scoring for memory modulation, allowing each modality's features to be independently suppressed when unreliable, and L1-normalized scoring for output fusion, enabling relative comparison across modalities.
This separation reflects the different roles of the two operations: absolute quality gating versus relative importance weighting.
