...
def sec_cards():
    return [
        ...
        h2("4.2 카드 표 (2026-09-15 06:50 KST 기준)"),
        ...
        table([
            ...
            ["E13Mc / E1Mc MCubeS 이식", "E13·E1 이 세 번째 벤치(편광·NIR 4센서)에서도 오르는가 · 레시피 그대로, 시드 3개씩", "두 카드 3시드 모두 완결", "—", "✅ E1Mc 통과 — 마지막 epoch 평균 +1.39(3/3 양수, 게이트 +0.5). ❌ E13Mc 근소 미달 +0.40. 같은 시드끼리 E1Mc 가 E13Mc 보다 +0.99 — E1 은 세 벤치 모두 양수"],
...
def sec_plan():
    return [
        ...
        table([
            ...
            ["yeon 0,1 / 2,3 / 6,7", "E1 확정 시드4 / 그 짝 C3-only 시드4 / E-LoRA arm C 시드 902", "DELIVER 4모달", "ep1 (09-15 04:5x 기동, 검증 통과)", "09-20 새벽경 · yeon 속도는 jarvis 의 절반"],
        ...
        table([
            ["항목", "결과", "판정"],
            ["MCubeS E1Mc 3시드 (09-15)", "마지막 epoch 58.68 / 57.71 / 58.93 (평균 58.44) vs 같은 시드 C3-off final 57.05", "✅ 게이트 통과 +1.39(3/3 양수). E1 이 세 벤치 모두 양수"],
