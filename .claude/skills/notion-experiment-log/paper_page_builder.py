...
def sec_cards():
    return [
        ...
        table([
            ...
            ["E13Mc / E1Mc MCubeS 이식", "E13·E1 이 세 번째 벤치(편광·NIR 4센서)에서도 오르는가 · 레시피 그대로, 시드 3개씩", "200ep 진행 중(hpca100 16:53 · yeon 09-15 06:40)", "—", "게이트 = 마지막 epoch 3시드 평균이 같은 시드 C3-off 기준선(57.93/57.67/58.62) 대비 +0.5 이상"],
...
def sec_plan():
    return [
        ...
        h2("6.1 진행 중 (서버별)"),
        P(B("다섯 서버 전수 실측(2026-09-14 12:53 KST). "), T("작업 12건 가동, 빈 GPU 는 jarvis 2장(E13 확정 시드2 재채점이 12:55 에 끝난 자리, 다음 카드 미정). bengio 4장은 06:55 에 비어 있다가 10:41 에 다른 사용자에게 넘어갔다. "),
        ...
        table([
            ...
            ["hpca100 0~3", "E13Mc(시드 3개) · E1Mc(시드 1개) — E13·E1 을 MCubeS 로 이식해 세 번째 벤치에서도 오르는지 확인", "MCubeS 4센서", "ep152~156 — E13Mc 57.75 / 56.95 / 57.53 · E1Mc 57.95", "09-14 16:36~16:53 · 게이트 = 마지막 epoch 3시드 평균이 같은 시드 C3-off 대비 +0.5 이상"],
