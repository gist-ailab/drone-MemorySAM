...
def sec_cards():
    return [
        ...
        h2("4.2 카드 표 (2026-09-15 07:40 KST 기준)"),
        ...
        table([
            ...
            ["E1 중간층 4탭 읽기", "기하 센서의 클래스 근거가 중간층에 있다 · 블록 6/12/18/24 를 FPN 레벨별로 투입", "40ep 두 시드 완결 → 200ep 확정 시드1 완주, 시드2·3 진행 중", "40ep +0.57 / +0.78 · 확정 시드1 +0.58 (test 54.63, Δtest +1.06)", "✅ 확정 시드1 이 두 게이트를 1페어로 넘김(판정은 3페어 후). 24클래스로 E13 확정 시드1(+0.45)을 앞섰으나 차이 0.13 은 평가 간격 차이 범위라 동급"],
