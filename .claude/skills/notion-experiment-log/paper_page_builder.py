...
def sec_cards():
    return [
        ...
        table([
            ...
            ["MUSES 페어 보강 E7 시드 902·903 · E1M 시드 903 · E1M 200ep", "E7 기준선이 한 시드뿐이라 시드2·3 페어가 성립하지 않았음 · 풀 런은 test 서버 제출 후보", "E7 두 시드 완주 · E1M 시드3 은 ep35 에서, 풀 런은 ep36 전후에서 디스크 가득 참으로 정지(09-15)", "—", "E7·E1M 시드3 공식 재채점 대기. 풀 런은 공간 확보 후 ep35 부터 이어 받기"],
