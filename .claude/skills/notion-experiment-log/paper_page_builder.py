...
def sec_plan():
    return [
        ...
        table([
            ...
            ["일일 카드 1~3일차 legal 완결", "E3 +1.40 · E1 +1.07 · E2 +0.72 · E4 −0.03 (DELIVER test, val-best ckpt) / MUSES 공식 val: E7 80.0756 · E7c 79.9417 · E1M 80.416", "E1·E3 통과 후보, E2 회색지대, E4 폐기, PhysAug-off 통일, E1M 게이트 미달 — 상세 §4"],
        ...
        table([
            ...
            ["4", "E1M(MUSES 4탭) ✅ 완주 +0.34(게이트 +1.0 미달) · E12(E1+E2) · E2s2 진행 중", "공통 상승·결합·재현", "hpca100", "양 벤치 +1.0 = '공통 한 단계' — MUSES 쪽은 미달"],
