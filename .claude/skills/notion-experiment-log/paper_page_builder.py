...
def sec_plan():
    return [
        ...
        h2("6.1 진행 중 (서버별)"),
        P(B("다섯 서버 전수 실측(2026-09-15 04:40 KST, 06:50 갱신). "), T("빈 GPU 는 yeon 2장(4·5, 조건별 평가 09:38 종료)이며 다음 카드는 미정이다. jarvis 0·3 에는 E1 시드2 재채점 뒤 E-LoRA arm C 시드 903 이 자동으로 이어진다. "),
