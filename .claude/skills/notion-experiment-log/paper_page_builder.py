...
def sec_summary():
    return [
        ...
        table([
            ...
            ["MUSES 공식 test", "79.788 · 3모달 · 단일 런", "DGFusion 79.5 · 4모달", "+0.29", "MM SAM-adapter 81.07 · RGB+L · GtA 82.39 · 카메라 단독", "−1.28 · −2.60", "C3 off"],
...
def sec_plan():
    return [
        ...
        table([
            ...
            ["3", "✅ 완료 — E7(off) 80.0756 vs E7c(on) 79.9417: PhysAug-off로 통일 확정. 남은 것 = P39.1 seed2 200ep 레시피의 PhysAug-off 3페어 재런(헤드라인 교체용)", "공정성 정정", "yeon/hpca100 2장 × 3", "공식 val 재측정 후 SOTA 표 교체"],
