...
def sec_cards():
    return [
        ...
        h2("4.2 카드 표 (2026-09-15 09:50 KST 기준)"),
        ...
        table([
            ...
            ["MUSES 페어 보강 E7 시드 902·903 · E1M 시드 903 · E1M 200ep", "E7 기준선이 한 시드뿐이라 시드2·3 페어가 성립하지 않았음 · 풀 런은 test 서버 제출 후보", "진행 중(hpca100)", "—", "E1 이 세 벤치 모두 양수라 풀 런을 먼저 확보"],
...
def sec_plan():
    return [
        ...
        table([
            ...
            ["hpca100 0 / 1", "E7 시드 902 / 903 — MUSES PhysAug-off 기준선의 시드 페어", "MUSES 3모달", "ep20 — 77.12 / 78.12", "09-15 09시경"],
            ["hpca100 2 / 3", "E1M 시드 903 / E1M 200ep 풀 런(시드 3407, test 제출 후보)", "MUSES 3모달", "ep20 — 78.32 / 79.05", "09-15 09시경 / 09-17 04시경"],
