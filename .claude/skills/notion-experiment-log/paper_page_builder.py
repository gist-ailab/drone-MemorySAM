...
def sec_cards():
    return [
        ...
        h2("4.2 카드 표 (2026-09-15 04:40 KST 기준)"),
        ...
        table([
            ...
            ["🥇 E13 = E1 + E3 결합", "중간층 읽기(특징 접점) + 센서별 prototype(손실)의 결합. 두 축이 직교한다는 가설", "40ep 세 시드 · 200ep 확정 세 시드 모두 완결", "40ep 평균 +0.91 · 확정 3시드 24클래스 55.13 / 55.25 / 55.59 (평균 55.33, 표준편차 0.24)", "🔴 판정 보류 — 게이트가 분모에 따라 갈린다. 시드 821 분모면 Δtest +1.56 · Δ24 +0.65 로 통과, 5시드 평균 54.39 면 Δtest +0.75 로 미달. 24클래스는 시드 간 흔들림이 25클래스의 1/5"],
            ...
            ["E13Mc / E1Mc MCubeS 이식", "E13·E1 이 세 번째 벤치(편광·NIR 4센서)에서도 오르는가 · 레시피 그대로, 시드 3개씩", "E13Mc 3시드 완결 · E1Mc 1/3", "—", "❌ E13Mc 근소 미달 — 마지막 epoch 끼리 같은 척도로 +0.40(시드별 +0.85 / −0.06 / +0.41, 게이트 +0.5). 09-14 에 적은 −0.62 는 기준선을 val 최고로 잰 척도 혼합이라 정정. E1Mc 시드3407 +1.71, 나머지 두 시드 09-15 오전"],
...
def sec_plan():
    return [
        ...
        h2("6.1 진행 중 (서버별)"),
        P(B("다섯 서버 전수 실측(2026-09-15 04:40 KST). "), T("작업 14건 가동. 빈 GPU 는 yeon 6장(0~3·6·7)이며 다음 카드는 미정이다. "),
        ...
        table([
            ...
            ["yeon 4,5", "E1Mc 시드 20260827 · 20260828 — E1 의 MCubeS 이식", "MCubeS 4센서", "ep144 — 57.75 / 58.18", "09-15 06:10~06:30"],
            ["lecun 0,1,2", "CAFuser Swin-T 대조군 재현(외부 기준선)", "DELIVER CLDE", "iter 266,000/266,667", "09-15 04:45경 · 공개값 val 68.12 / test 55.80"],
        ]),
