...
def sec_cards():
    return [
        ...
        h2("4.2 카드 표 (2026-09-15 20:30 KST 기준)"),
        ...
        table([
            ...
            ["E1 중간층 4탭 읽기", "기하 센서의 클래스 근거가 중간층에 있다 · 블록 6/12/18/24 를 FPN 레벨별로 투입", "40ep 두 시드 · 200ep 확정 시드1·2 완결, 시드3 진행 중(09-16 02시)", "확정 24클래스 55.26 / 55.85 (2시드 평균 55.55)", "판정 대기 — 같은 코드 기준선 902·903(09-17) 과의 매칭 쌍이 1차 근거. 24클래스로 E13 확정 3시드(55.33)와 동급. 조건별(시드1): 다섯 조건 24클래스 Δ +0.06~+1.19, 얇은 객체 4클래스는 다섯 조건 모두 카드 중 최고 → 악조건 규칙 통과"],
...
def sec_plan():
    return [
        ...
        table([
            ...
            ["jarvis 2,4", "E1 확정 런 시드3 — 중간층 4탭 읽기 단독 카드의 200ep 확정", "DELIVER 4모달", "ep154 — 최고 68.53", "09-16 02:30 · 완주 판정 뒤 legal 재채점이 자동으로 이어진다"],
