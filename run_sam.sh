export cur_dir=`pwd`
export save_exp_name="0209_DELIVER_RGBDE_LORA_SAM2_P8_lora_lr00006"
export CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7"

folder_name="0209_DELIVER_RGBDE_LORA_SAM2_P8_lora_lr00006"
...
python3 -u -m torch.distributed.launch --nproc_per_node=8 --master_port=21612 --use_env train_sam2_lora_paper.py \
 --cfg configs/levine-deliver_rgbde_P8.yaml \
