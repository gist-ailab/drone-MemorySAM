export cur_dir=`pwd`
export save_exp_name="0206_DELIVER_RGBDEL_LORA_SAM2_P8_lora_lr00006"
export CUDA_VISIBLE_DEVICES="0,1,2,3"

folder_name="0206_DELIVER_RGBDEL_LORA_SAM2_P8_lora_lr00006"
...
python3 -u -m torch.distributed.launch --nproc_per_node=4 --master_port=21612 --use_env train_sam2_lora_paper.py \
 --cfg configs/hpc_deliver_rgbdel_P8.yaml \
