"""MoE/LoRA/adapter 레이어류: Soft-MoE LoRA, DeBA adapter, qkv wrapper (구 sam_lola_utils.py에서 verbatim 이동)."""
import math
import torch
import torch.nn as nn
import torch.nn.functional as F

__all__ = ['_LoRA_qkv', 'MoE_LoRA_Layer', '_MoE_LoRA_qkv', 'SoftMoE_LoRA_Layer', 'SharedGateMLP', 'SoftMoE_LoRA_Layer_V2', '_SoftMoE_LoRA_qkv', 'DeBAFP', 'DeBAFP_MultiScale', 'MoE_DeBA_BB', '_MoE_DeBA_BB_qkv']
