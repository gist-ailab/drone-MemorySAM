% !TEX root = memorysam_technical_report.tex
\documentclass[10pt, a4paper]{article}

% 문서 여백 등 기본 설정을 위한 패키지
\usepackage{geometry}
...
% MemorySAM Technical Report for MaCVi 2026 MULTIAQUA Challenge
% Half-column format following CVPR template appendix style
